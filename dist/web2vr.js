...
var AframeContext = /*#__PURE__*/function () {
  ...
  _createClass(AframeContext, [{
    ...
    value: function createControllers() {// event listener for the keyboard key press 
...
var InputElement = /*#__PURE__*/function (_TextElement) {
  ...
  function InputElement(web2vr, domElement, layer) {
    ...
    _this.entity.addEventListener("click", function () {
      document.querySelector("a-scene").emit("element-input-click", _assertThisInitialized(_this));
    });
...
/* harmony import */ var aframe_gif_shader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! aframe-gif-shader */ "./node_modules/aframe-gif-shader/dist/aframe-gif-shader.js");
/* harmony import */ var aframe_gif_shader__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(aframe_gif_shader__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./settings */ "./src/settings.js");
/* harmony import */ var _components_border__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/border */ "./src/components/border.js");
/* harmony import */ var _components_border__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_border__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _components_animate__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/animate */ "./src/components/animate.js");
/* harmony import */ var _components_animate__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_animate__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _components_grabRotateStatic__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/grabRotateStatic */ "./src/components/grabRotateStatic.js");
/* harmony import */ var _components_grabRotateStatic__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_grabRotateStatic__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _scroll__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./scroll */ "./src/scroll.js");
/* harmony import */ var _aframeContext__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./aframeContext */ "./src/aframeContext.js");
/* harmony import */ var _elements_containerElement__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./elements/containerElement */ "./src/elements/containerElement.js");
/* harmony import */ var _elements_textElement__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./elements/textElement */ "./src/elements/textElement.js");
/* harmony import */ var _elements_imageElement__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./elements/imageElement */ "./src/elements/imageElement.js");
/* harmony import */ var _elements_videoElement__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./elements/videoElement */ "./src/elements/videoElement.js");
/* harmony import */ var _elements_checkboxElement__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./elements/checkboxElement */ "./src/elements/checkboxElement.js");
/* harmony import */ var _elements_radioElement__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./elements/radioElement */ "./src/elements/radioElement.js");
/* harmony import */ var _elements_inputElement__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./elements/inputElement */ "./src/elements/inputElement.js");
/* harmony import */ var _elements_buttonElement__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./elements/buttonElement */ "./src/elements/buttonElement.js");
/* harmony import */ var _elements_svgElement__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./elements/svgElement */ "./src/elements/svgElement.js");
/* harmony import */ var _elements_canvasElement__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./elements/canvasElement */ "./src/elements/canvasElement.js");
function _createForOfIteratorHelper(o, allowArrayLike) { var it; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
...
var Web2VR = /*#__PURE__*/function () {
  function Web2VR(container) {
    ...
    this.settings = deepmerge__WEBPACK_IMPORTED_MODULE_1___default()(new _settings__WEBPACK_IMPORTED_MODULE_3__["default"](), settings, {
      arrayMerge: function arrayMerge(destination, source) {
        return [].concat(_toConsumableArray(destination), _toConsumableArray(source));
      }
    }); // aframe context

    this.aframe = new _aframeContext__WEBPACK_IMPORTED_MODULE_8__["default"](this.settings); // vr elements
  ...
  _createClass(Web2VR, [{
    ...
    value: function init() {
      ...
      this.scroll = new _scroll__WEBPACK_IMPORTED_MODULE_7__["default"](this);
      ...
      var interval = setInterval(function () {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            if (element instanceof _elements_imageElement__WEBPACK_IMPORTED_MODULE_11__["default"] && !element.loaded) allLoaded = false;
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
    ...
    value: function addElement(domElement, parentElement, layer) {
      ...
      if (domElement.nodeType == Node.TEXT_NODE && domElement.nodeValue.trim()) {
        ...
        element = new _elements_textElement__WEBPACK_IMPORTED_MODULE_10__["default"](this, span, layer);
      } // for future convert this to switch statement
      else if (domElement.tagName == "VIDEO") element = new _elements_videoElement__WEBPACK_IMPORTED_MODULE_12__["default"](this, domElement, layer);else if (domElement.tagName == "IMG") element = new _elements_imageElement__WEBPACK_IMPORTED_MODULE_11__["default"](this, domElement, layer);else if (domElement.tagName == "svg") element = new _elements_svgElement__WEBPACK_IMPORTED_MODULE_17__["default"](this, domElement, layer);else if (domElement.tagName == "CANVAS") element = new _elements_canvasElement__WEBPACK_IMPORTED_MODULE_18__["default"](this, domElement, layer);else if (domElement.tagName == "BUTTON") element = new _elements_buttonElement__WEBPACK_IMPORTED_MODULE_16__["default"](this, domElement, layer);else if (domElement.tagName == "TEXTAREA") element = new _elements_inputElement__WEBPACK_IMPORTED_MODULE_15__["default"](this, domElement, layer);else if (domElement.tagName == "INPUT") {
          var type = domElement.getAttribute("type");
          if (type == "checkbox") element = new _elements_checkboxElement__WEBPACK_IMPORTED_MODULE_13__["default"](this, domElement, layer);else if (type == "radio") element = new _elements_radioElement__WEBPACK_IMPORTED_MODULE_14__["default"](this, domElement, layer);else if (["text", "email", "number", "password", "search", "tel", "url"].includes(type)) element = new _elements_inputElement__WEBPACK_IMPORTED_MODULE_15__["default"](this, domElement, layer);else if (["button", "submit", "reset"].includes(type)) {
            element = new _elements_buttonElement__WEBPACK_IMPORTED_MODULE_16__["default"](this, domElement, layer);
          } else return;
        } // any other type of element will be container
        else if (domElement.nodeType == Node.ELEMENT_NODE) {
            element = new _elements_containerElement__WEBPACK_IMPORTED_MODULE_9__["default"](this, domElement, layer);
          } else return;
    ...
    value: function addElementChildren(currentNode) {
      ...
      if (!element || element instanceof _elements_svgElement__WEBPACK_IMPORTED_MODULE_17__["default"]) return;
